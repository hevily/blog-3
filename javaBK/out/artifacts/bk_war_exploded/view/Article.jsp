...
<html lang="en">
	<head>
		...
		<style type="text/css">
			.pagination {color: #ac8b72;text-align: center;margin: 8px;}
			.pagination span {color: #ac8b72;margin:0 5px ;padding: 3px 6px;border: solid thin #ac8b72;}
			.pagination span.on {background-color: #0099FF;color: #fff;border: solid thin #0099FF;}
			.pagination a{text-decoration: none;}
			.pagination a span {border: 1px solid #F5F5F5;color: #ac8b72;}
				...
				<div class="main-left main-left-fadeinL">
					<div class="location">
						<p>
							...
							<span>您当前的位置：</span>
							<a href="index.jsp">首页</a><span>></span><span>博文</span>
						</p>
					</div>
