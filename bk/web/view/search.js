$(function () {
    //获取所有文章列表
    // alert($.cookie('searchText'))
    var currentPage = 1; // 当前页码, 从1开始
    function  Refresh(currentPage) {
        $.ajax({
            type:"post",
            url:"essay?action=getEssayByTitle",
            data:{
                'title':$.cookie('searchText')
            },
            dataType:"json",
                    ...
                    function initPage() {
                        ...
                        for(var o = ((currentPage-1)*pageSize); o <maxIndex; o++) {
                            arr.push('<article class=" clearfix" id="'
                                ...
                                '">'+o+'<a href="../view/articleDetail.jsp"> <div class="article-bg"> <img src="../assets/img/1-1504022119110-L.jpg" alt="文章图片"></div> <div class="article-content"> <header> <h3>'
