...
<head>
    ...
    <script src="<%=basePath%>/view/category.js"></script>
</head>
<body>
        ...
        <div class="main-left main-left-fadeinL">
            <div class="location">
                <p>
                    ...
                    <span>您当前的位置：</span>
                    <a href="<%=basePath%>/view/index.jsp">首页</a><span>></span><a href="<%=basePath%>/view/Article.jsp"><span>博文</span></a><span>></span><span class="catagoryLocation italic"></span>
                </p>
            </div>
